...
#     self.comm_embedding = nn.Embedding((token_num+1)*(map_size//self.pos_down_sample)**2, embed_dim)
#     self.comm_fc = nn.Linear(embed_dim*(2*self.max_comm_obs+1), input_size)
